        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-gray-500">
              ...
              <div className="text-gray-500">drag & drop to upload</div>
              <div className="mt-3">
...
const Button = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <button
      className={`focus-visible:ring-ring inline-flex cursor-pointer items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50 text-white px-2 py-1 bg-primary border border-gray-400 shadow hover:bg-[#c1acfd] ${className}`}
      ref={ref}
      {...props}
    />
  );
